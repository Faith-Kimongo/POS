...
class WaiterController extends Controller
{
    ...
    {
        //
        $waiters=User::where('added_by',Auth::id())->get();
        return view('management.waiters.index',compact('waiters'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/management/waiters')->with('success', 'Chef  succefully registered!');
        dd($password);
    }
